...
# DATASET /kaggle/input/network-multiflow-fingerprinting-datasets/ETF_IoT.json
DATASET_FOLDER = '/kaggle/input/network-multiflow-fingerprinting-datasets/'
DATASET_NAME = 'ETF_IoT' 
...
# output /kaggle/working/output/20230505_test
OUTPATH = '/kaggle/working/output/20230505_test/'
